...
<div class="project-figure-grid inline-figure-flow">
  <figure class="project-figure-card"><img src="lift-up-paper-fig-14-xgb-p3-i5-1046x688.png" alt="XGBoost split gain analizi"><figcaption>Bu görsel, XGBoost’ta bir karar ağacının nereden bölüneceğine nasıl karar verildiğini açıklar. Her aday split için sol ve sağ alt grupların gradient/Hessian toplamları hesaplanır; hata azalımı ve düzenlileştirme etkisi birlikte değerlendirilir. En yüksek gain veren split, veri uzayını en anlamlı iki parçaya ayırdığı için seçilir.</figcaption></figure>
</div>
...
<div class="project-figure-grid inline-figure-flow">
  <figure class="project-figure-card"><img src="lift-up-paper-fig-19-ft-p4-i2-510x140.png" alt="FT-Transformer genel akışı"><figcaption>Bu görsel FT-Transformer’ın genel veri akışını gösterir. Feature tokenizer ham sayısal ve kategorik girdileri token temsillerine dönüştürür; transformer encoder bu tokenlar arasındaki ilişkileri öğrenir; prediction head ise son temsilden Specific Range tahminini üretir. Bu yapı, uçuş değişkenlerinin birbirine bağlı etkilerini tek mimari içinde modellemek için kullanıldı.</figcaption></figure>
  <figure class="project-figure-card"><img src="lift-up-paper-fig-29-ft-p8-i2-512x280.png" alt="Transformer encoder blok yapısı"><figcaption>Bu görsel encoder bloğunun içini gösterir. Multi-Head Self-Attention tokenlar arasındaki ilişki ağırlıklarını hesaplar, FFN katmanı bu temsilleri doğrusal olmayan biçimde işler, residual bağlantılar bilgi akışını korur, LayerNorm ise eğitimi kararlı hale getirir. Bu bileşenler FT-Transformer’ın kolonlar arası bağlamı öğrenmesini sağlar.</figcaption></figure>
</div>
