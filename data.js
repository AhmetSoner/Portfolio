    ...
    projectTeams: [
      {
        ...
        overview: [
          ...
          "The theoretical foundation of developed smart systems is validated through simulation and animation applications to ensure field applicability and hardware integration efficiency. Conducting its R&D activities under high engineering standards, HAYA actively represents our country in national and international platforms with original project models."
        ],
        contributions: [
      ...
      },
      {
        ...
        overview: [
          "Founded in March 2023, Tulpar Tharros Team (TTT) combines the winged horse figure 'Tulpar' from Turkic mythology with the concept 'Tharros' representing courage, perseverance, and motivation. The core objective of the team is to produce technological and scientific solutions in Aviation and Aerospace Sciences, pioneering research with high commercialization and operational impact in both sectoral and academic domains.",
          "Operating with an R&D and discipline-oriented approach across various engineering branches, the team works on smart inspection platforms, soft robotics, visual AI inspection algorithms, and ergonomic maintenance solutions for aircraft maintenance, repair, and overhaul (MRO) processes."
        ],
        contributions: [
      ...
      },
      {
        ...
        outcomes: ["2023 International Electric Vehicle Races Hydromobile 2nd Place", "2023 TEKNOFEST International Electric Vehicle Races Special Jury Award", "Shell Eco-Marathon Finalisti"],
        outcomeDetails: [
          {
    ...
    projects: [
      {
          ...
          "category": "guc-elektronigi",
          "summary": "Vol.1 BLDC motor driver board developed for hydrogen vehicle powertrain; featuring 50 A nominal / 100 A peak switching from 48 V DC bus, Hall sensor decoding, and STM32 microcontroller PWM control.",
          "description": "Vol.1 motor driver project covers three-phase BLDC motor speed, direction, current, and temperature closed-loop control, power stage thermal management, bootstrap gate driver design, and fault protection algorithms.",
          "image": "vol1/Resim33.png",
          "tags": [
                    "BLDC Motor Driver",
                    "STM32F446RET6",
          ...
          "specs": [
                    ...
                    },
                    {
                              ...
                              "value": "IRS2186 gate driver, INA229 current-voltage-power telemetry"
                    },
                    {
                              "name": "Design & Verification",
                              "value": "Altium Designer PCB, Proteus simulation, oscilloscope & prototype bench testing"
                    }
          ],
          "overview": "<p>This page is prepared based on the Motor Driver Technical Design Vol.1 document. The project presents the first-generation three-phase BLDC motor driver board designed to operate on a 48 V DC bus with high-current switching, Hall sensor feedback, and STM32 microcontroller-based PWM control.</p><h4>4.1. Circuit Design</h4><strong class='method-subtitle'>4.1.1. Motor Driver Circuit Design Steps</strong><br><strong class='method-subtitle'>A) Topology Selection</strong><br><p>A Three-Phase Bridge topology was selected to minimize energy loss and maximize efficiency for high-power brushless DC motor applications. This topology allows independent phase control (Phase A, B, C) and precise speed/direction regulation.</p><strong class='method-subtitle'>B) Voltage and Current Rating Determination</strong><br><p>Designed for 2500 W nominal power, operating at 48 V nominal voltage and 50 A nominal current. The board is engineered with a safety margin to withstand transient surge currents up to 100 A.</p><strong class='method-subtitle'>C) Switching Frequency</strong><br><p>Switching frequency was optimized considering target motor RPM, thermal dissipation, gate driver response time, and EMC behavior.</p><strong class='method-subtitle'>4.1.2. Analytical Model & Control Architecture</strong><br><p>Theoretical foundations and mathematical models were implemented on the Control Board, integrating PWM generation, feedback loops, and sensor processing.</p><strong class='method-subtitle'>4.1.3. Component Selection</strong><br><p>SMD components were prioritized for compact layout and automated assembly. Passive components were chosen based on peak power ratings and tight tolerances.</p><strong class='method-subtitle'>A) Capacitors:</strong> Parallel ceramic MLCC capacitors (100 nF, 1 uF) used for high-frequency filtering.<br><strong class='method-subtitle'>B) Resistors:</strong> Power-rated current shunt and precision voltage divider resistors selected.<br><strong class='method-subtitle'>C) Inductors:</strong> Low-ESR SMT power inductors chosen for power supply stabilization.<br><strong class='method-subtitle'>D) MOSFETs:</strong> N-channel IXTH230N10T MOSFETs (100 V, 230 A, low R_DS(on)) selected.<br><strong class='method-subtitle'>E) Gate Driver:</strong> IRS2186 high/low-side drivers chosen for 4 A source/sink current and 170 ns fast switching.<br><strong class='method-subtitle'>F) Microcontroller:</strong> STM32F446RET6 ARM Cortex-M4 running at 180 MHz selected for real-time motor control.",
          "architecture": "<p>PCB and power stage design prioritized high-current trace widths, copper pour planes, bootstrap/bypass capacitor placement near driver ICs, and multi-stage power rail stability.</p><h4>4.4. Printed Circuit Board (PCB) Layout</h4><p>Designed in Altium Designer using multi-layer copper pour strategy with thermal vias under switching MOSFETs to distribute thermal load effectively.</p><h4>4.5. Prototype & Testing Stages</h4><p>Low-power prototype boards were assembled and tested prior to full production, validating gate driver switching waveforms and thermal stability under load.</p>",
          "subsystems": [],
          "analysis": "<p>Validation included prototype testing, oscilloscope gate signal observations, power loss calculations, nominal efficiency evaluation, and safety fault mode algorithms for overcurrent and overtemperature conditions.</p><h4>4.6. Motor Driver Efficiency</h4><p>Under 48 V / 50 A (2400 W) nominal operation, MOSFET conduction losses were calculated at approximately 40 W, yielding a nominal power stage efficiency around 98.33% (90% overall system efficiency).</p><h4>4.7. Motor Driver Protection</h4><p>Overcurrent and overtemperature protection algorithms sample INA229 sensor telemetry via SPI. Upon fault detection, the system triggers a 3-stage safe mode to shut off motor power until fault conditions clear.</p>",
...
},
      {
            ...
            "category": "guc-elektronigi",
            "summary": "Real-time insulation resistance monitoring device between 48 V DC battery bus and vehicle chassis, using switched resistor bridge and isolated telemetry for electric vehicle safety.",
            "description": "Designed for 48 V hydrogen fuel cell vehicle safety compliance, evaluating both asymmetric and symmetric ground faults via switched resistor network and isolated measurement channels.",
            "image": "isolation/ev-isolation-cover.jpg",
            "tags": [
                  "48 V Vehicle Safety",
            ...
            "subsystems": [
                  {
                        ...
                        "desc": "Creates distinct measurement states under relay S open/closed conditions to calculate Rp and Rn chassis insulation resistance."
                  },
                  {
                        "title": "AD8216 Measurement Stage",
                        "desc": "Conditions small differential voltages at positive/negative battery terminals to ADC voltage levels."
                  },
                  {
                        "title": "AMC1311 Isolated Telemetry",
                        "desc": "Separates isolation board ground from low-voltage controller ground to transfer analog measurement safely."
                  },
                  {
                        "title": "Optocoupler Relay Driver",
                        "desc": "Drives measurement switching relays while maintaining galvanic isolation with the controller board."
                  }
            ],
      ...
      },
      {
            ...
            "category": "guc-elektronigi",
            "summary": "Second-generation modular BLDC motor driver system developed for 48 V nominal / 2 kW hydrogen powertrain; featuring isolated UCC21520 gate drivers, ACS758 current telemetry, and low-ESR bulk capacitance bank.",
            "description": "Vol.2 driver revision features modular board partitioning (power, control, regulator), enhanced thermal dissipation, PSpice/Simulink co-simulations, and 97.15% power stage efficiency.",
            "image": "vol2/3d-bldc-on.png",
            "detailImage": "vol2/3d-bldc-on.png",
            "tags": [
      ...
      },
      {
            "id": "project-4",
          "pdfFile": "bird-strike/bird-strike-project-paper.pdf",
          "pdfTitle": "Deep Learning-Based Bird Detection & Warning System for Airports Report (PDF)",
            "title": "Havaalanları İçin Derin Öğrenme Tabanlı Kuş Tespit Sistemi (TÜBİTAK 2209-A)",
            "category": "havacilik-ai",
            "summary": "Havaalanlarında kuş çarpması riskini azaltmak için geliştirilen bu TÜBİTAK 2209-A araştırma projesinde, pist ve havaalanı çevresindeki kuş hareketlerini görüntü tabanlı olarak algılayabilecek bir derin öğrenme hattı kuruldu. YOLOv8n modeli kullanılarak kuşların görüntü içinde tespit edilmesi, tür seviyesinde sınıflandırılması ve güven değeriyle birlikte yorumlanması hedeflendi. Çalışma; veri seti hazırlama, Roboflow tabanlı etiketleme, augmentation, model eğitimi ve performans doğrulama adımlarını kapsayan uçtan uca bir yapay zeka uygulaması olarak geliştirildi. Elde edilen yaklaşım, radar tabanlı sistemlerin sağlayamadığı görsel tür bilgisiyle havaalanı erken ikaz altyapılarını destekleyebilecek bir karar destek katmanı sunmaktadır.",
            "description": "TÜBİTAK 2209-A supported research developing a YOLOv8 deep learning visual bird species detection, tracking, and risk alert system to prevent bird strike incidents around airports.",
            "image": "bird-detection-airport-cover.png",
            "detailImage": "bird-detection-airport-cover.png",
            "tags": [
                  "YOLOv8n",
            ...
            "subsystems": [
                  {
                        "title": "Data Collection & Species Selection",
                  ...
                  {
                        "title": "YOLOv8n Tespit Modeli",
                        "desc": "Lightweight YOLOv8n model trained as core deep learning engine for real-time bird object detection."
                  },
                  {
      ...
      },
      {
          ...
          "category": "robotik",
          "summary": "AI-assisted inflatable soft robot system designed within Tulpar Tharros Team for inspecting confined aircraft fuel tanks and narrow MRO spaces safely.",
          "description": "INFLOBOT is a soft robotics inspection assistant combining lighting, oxygen support, CO2 steering, and AI damage detection; recognized as finalist at THY Design Hackathon 2023 and awarded Best Startup at TEKNOFEST 2023.",
          "image": "inflobot-figures/images.jpg",
          "detailImage": "inflobot-figures/images.jpg",
          "teamIds": [
                    "team-tulpar-tharros"
          ...
          "specs": [
                    ...
                    },
                    {
                              ...
                              "value": "Turkish Airlines Design Hackathon 2023 & TEKNOFEST Entrepreneurship Competition 2023"
                    },
                    {
                              "name": "Industrial Context",
                              "value": "Aircraft fuel tank inspection and narrow MRO space visual auditing"
                    },
                    {
                              "name": "My Project Role",
                              "value": "Founding team member; electrical-electronics, system architecture & 3D compressor support module design"
                    },
                    {
                              "name": "Proje Ekibi",
                              "value": "Ahmet Soner GÜLEÇ, Özgür KURT, İltemir Taha BİNALİ, Sühan Göktuğ AYDEMİR, Bahadır SARIKARAMAN"
          ...
          "subsystems": [
                    {
                              ...
                              "desc": "Primary soft robot concept providing illumination, oxygen feed, and steerable reach inside fuel tank compartments."
                    },
                    {
                    ...
                    {
                              "title": "CO2 Pneumatic Steering System",
                              "desc": "Pneumatic actuation infrastructure inflating distinct channels with non-flammable CO2 to extend and curve soft arms."
                    },
                    {
                              "title": "Imaging & AI Detection Layer",
                              "desc": "Telemetry and image processing layer collecting visual data for automated crack, corrosion, and damage detection."
                    }
          ],
      ...
      {
            "id": "project-6",
            "title": "Modeling & Comparison of Combat Aircraft Flight Performance Dataset Using Machine Learning Methods",
            "category": "havacilik-ai",
            "summary": "Türk Havacılık ve Uzay Sanayii A.Ş. (TUSAŞ) LIFT UP Programı ve TÜBİTAK 2209-B Sanayi Odaklı Araştırma Projeleri Destek Programı (Proje No: 1999B212502693 / LIFTUP-2025-2026) kapsamında Milli Muharip Uçak (KAAN) aviyonik seyrüsefer sistemleri için yürütülen bu çalışmada; U-Net CNN ve Optik Karakter Tanıma (OCR) ile dijitalleştirilen Uçuş El Kitabı (AFM) nomogram verileri üzerinde Kübik İnterpolasyon, XGBoost ve Tabular Transformer (FT-Transformer) modellerinin NVIDIA Jetson Orin Nano gömülü hedef ortamındaki çıkarım hızı, bellek ayak izi ve tahmin doğruluğu benchmark analizleri gerçekleştirilmiştir.",
            "description": "TUSAŞ (Türk Havacılık ve Uzay Sanayii A.Ş.) LIFT UP Sanayi Odaklı Lisans Bitirme Projeleri Programı kapsamında yürütülen bu çalışmada, muharip hava araçlarında kritik uçuş performans parametrelerinin (Özgül Menzil, İrtifa, Mach Sayısı, Yakıt Akışı, Sürükleme İndeksi vb.) hesaplanmasında kullanılan geleneksel kübik interpolasyon arama tablosu yöntemi ile yapay zeka modelleri (XGBoost ve Tabular Transformer) doğrusal olmayan davranışlar, çıkarım hızı, bellek ayak izi ve işlemci yükü açısından karşılaştırılmıştır.",
            "image": "kaan.jpg",
            ...
            "specs": [
                  {"name": "Kurum / Sanayi Ortağı", "value": "Türk Havacılık ve Uzay Sanayii A.Ş. (TUSAŞ)"},
                  {"name": "Recognition Programs", "value": "TUSAŞ LIFT UP & TÜBİTAK 2209-B Programı"},
                  {"name": "TÜBİTAK Proje No", "value": "1999B212502693"},
                  {"name": "TUSAŞ Proje Kodu", "value": "LIFTUP-2025-2026-AV-06"},
                  {"name": "Sanayi Danışmanı", "value": "Zeynel Abidin AYDOĞAN (TUSAŞ - Havacılık Müh.)"},
                  {"name": "Akademik Danışman", "value": "Doç. Dr. Aziz KABA (ESTÜ Pilotaj)"},
            ...
            "overview": "<p>Conducted under the TUSAŞ LIFT UP Program and TÜBİTAK 2209-B (Project No: 1999B212502693 / LIFTUP-2025-2026), this study benchmarks Cubic Interpolation, XGBoost, and Tabular Transformer (FT-Transformer) models for calculating combat aircraft flight performance parameters on embedded target hardware.</p>",
            ...
            "architecture": "<h4>2. End-to-End System Architecture</h4><br><div class='visual-callout-grid'><div class='visual-callout-card'><span class='visual-kicker'>Input</span><strong>AFM / POH Nomograms</strong><p>Performance charts representing corrected flight data derived from CFD, wind tunnel, flight testing, and certification processes.</p></div><div class='visual-callout-card'><span class='visual-kicker'>Transformation</span><strong>Segmentation + OCR + Calibration</strong><p>Nomogram curves isolated from grid/text noise; pixel coordinates mapped to physical flight variables.</p></div><div class='visual-callout-card'><span class='visual-kicker'>Output</span><strong>Model-ready Master Table</strong><p>Altitude, gross weight, drag index, Mach, fuel flow, engine type, and specific range merged into a unified data pipeline.</p></div></div><strong>2.1. Raw Data & Nomogram Logic</strong><br>Flight performance nomograms are engineering artifacts combining CFD, wind tunnel, flight testing, and safety margins. Each curve represents a physical performance surface. In this project, corrected nomogram data was digitized and structured to model altitude, temperature, gross weight, drag index, and Mach number influences.<br><br><strong>2.2. Digitization Pipeline</strong><br>A U-Net segmentation architecture was trained to isolate target performance curves from grid lines, axis labels, and background noise. OCR was integrated for axis calibration, transforming pixel coordinates into physical units.<br><br><strong>2.3. Master Dataset</strong><br>Structured following Tidy Data principles into a master dataset of 54,620 rows across altitude, gross_weight, drag_index, mach, fuel_flow, engine_type, and specific_range.<br><br><strong>2.4. Benchmark Models</strong><br>Evaluated 4D cubic spline interpolation as baseline reference against XGBoost gradient boosted trees and FT-Transformer tabular self-attention architecture.",
            "riskManagement": "\n<strong>3. RİSK YÖNETİMİ VE B PLANLARI</strong><br><br>\n\n<table class='hud-benchmark-table' style='width:100%; border-collapse:collapse; margin:10px 0; border:1px solid rgba(0,240,255,0.2);'>\n  <thead style='background:rgba(0,240,255,0.1); color:var(--primary); font-family:var(--font-header); font-size:0.85rem;'>\n    <tr>\n      <th style='padding:8px; border:1px solid rgba(0,240,255,0.2); width:40%;'>Öngörülen Risk</th>\n      <th style='padding:8px; border:1px solid rgba(0,240,255,0.2); width:60%;'>Alınacak Tedbirler (B Planı)</th>\n    </tr>\n  </thead>\n  <tbody style='font-size:0.9rem; color:var(--text-main);'>\n    <tr>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1); font-weight:bold;'>1. AFM Nomogram Gizlilik Kısıtı: Muharip uçak verilerine erişilememesi.</td>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1);'>Metodoloji değişmeyecektir. Açık kaynaklı F-16 uçuş dinamikleri modeli veya NASA DASHlink doğrulanmış uçuş verisi setleri üzerinde uygulanacaktır.</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1); font-weight:bold;'>2. Model Yetersizliği: Hiperparametre optimizasyonuna rağmen düşük doğruluk.</td>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1);'>Veri seti GAN (Generative Adversarial Networks) teknikleriyle sentetik olarak zenginleştirilecek ve modeller yeniden eğitilecektir.</td>\n    </tr>\n    <tr>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1); font-weight:bold;'>3. Gömülü Donanım Uyumsuzluğu / OOM: Cihazda çalışmama veya ani bellek taşması.</td>\n      <td style='padding:8px; border:1px solid rgba(0,240,255,0.1);'>Docker konteynerizasyon teknolojisi (<code>--memory='512m'</code>, <code>--cpus='0.5'</code>) kullanılarak gömülü sistem işlemci ve bellek kısıtları sanal olarak simüle edilecektir.</td>\n    </tr>\n  </tbody>\n</table>\n",
            "subsystems": [
                  {
                        "title": "U-Net & OCR Digitization Pipeline",
            ...
            "analysis": "<h4>3. Results and Discussion</h4><br><p>Evaluated cubic interpolation, XGBoost, and FT-Transformer models across prediction accuracy, inference latency, Peak RSS memory, CPU load, model artifact size, and hardware suitability on NVIDIA Jetson Orin Nano.</p><p>XGBoost achieved the highest balance between accuracy (RMSE: 0.003468, MAE: 0.001372, MAPE: 1.560%, R² > 0.99) and fast inference latency (2.30 ms p95), outperforming traditional lookup tables and deep learning baselines for real-time edge deployment.</p>",
            "achievements": "<h4>4. Conclusion & Outputs</h4><br><p>The project successfully demonstrated that machine learning models can replace traditional lookup table interpolation in combat aircraft avionics navigation systems, providing higher accuracy and lower memory footprint on embedded hardware platforms.</p>"
      }
],
    gallery: [
      {
