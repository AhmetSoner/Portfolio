  ...
  tr: {
    ...
    projects: [
      ...
      },
      {
            ...
            "image": "inflobot-figures/inflobot-soft-robot-cover.jpg",
            "detailImage": "inflobot-figures/inflobot-soft-robot-cover.jpg",
            "teamIds": [
                        "team-tulpar-tharros"
            ],
            "tags": [
            ...
            "specs": [
                        ...
                        {
                                    "name": "Yarışma ve Programlar",
                                    "value": "THY Design Hackathon 2023, TEKNOFEST Girişimcilik, Take Off İstanbul"
                        },
                        {
                                    "name": "Proje Ekibi",
                        ...
                        {
                                    "name": "Problem Alanı",
                                    "value": "Uçak yakıt tankları, kanat içi hacimler, aviyonik kompartımanlar ve insan ergonomisine uygun olmayan dar MRO bölgeleri"
                        },
                        {
                                    "name": "Çözüm Yaklaşımı",
                                    "value": "Bio-inspired, şişirilebilir yumuşak robot; CO2 basınç kanallarıyla yönlenme, LED aydınlatma ve kamera/sensör destekli muayene"
                        },
                        {
                                    "name": "Alt Sistemler",
                                    "value": "TA-8 bakım destek kolu, TS-5 dar alan muayene başlığı, oksijen destek hattı, CO2 kompresör destek ünitesi"
                        },
                        {
                                    "name": "Malzeme ve Donanım",
                                    "value": "TPE/TPU tabanlı esnek gövde, kamera/boroskop, sensörler, LED/OLED aydınlatma, güvenli kablolama ve uzaktan kontrol arayüzü"
                        },
                        {
                                    "name": "Hedef Kazanım",
                                    "value": "Bakım süresini ve iş gücü kaybını azaltan, teknisyen güvenliğini artıran, ürünleşmeye açık soft robotics tabanlı MRO asistanı"
                        }
            ],
            "overview": "<p>INFLOBOT, Tulpar Tharros Havacılık Topluluğu kapsamında uçak yakıt tankları ve benzeri dar bakım hacimleri için geliştirilen yapay zeka destekli, şişirilebilir yumuşak robot konseptidir. LIFT UP projesindeki sayfa düzeniyle uyumlu biçimde bu bölümde proje; kurum/takım bağlamı, problem, çözüm yaklaşımı, teknik mimari ve çıktı mantığı üzerinden anlatılmaktadır. Çalışmanın çıkış noktası, klasik bakım yöntemlerinde teknisyenin tank içine girmesini zorunlu kılan, yüksek zaman kaybı ve güvenlik riski oluşturan yakıt tankı muayene sürecidir.</p><p>Yakıt tankı bakımında teknisyen; dar erişim panelleri, kanat içi nervürler, düşük görüş, zehirli yakıt buharı, patlama/yangın riski, oksijen yetersizliği ve hareket kısıtlarıyla aynı anda mücadele eder. Mevcut yöntemlerde yakıtın boşaltılması, elektrik kaynaklarının kapatılması, tankın uzun süre havalandırılması, kişisel koruyucu donanımla içeri girilmesi ve dışarıda güvenlik ekibinin beklemesi gerekir. Kaynak dokümanlarda bu hazırlık sürecinin tank büyüklüğüne bağlı olarak 8-12 saatten 12-24 saate kadar uzayabildiği; bu sırada diğer bakım faaliyetlerinin de aksayabildiği vurgulanır.</p><p>INFLOBOT bu problemi, teknisyenin görüşünü ve erişimini dar alan içinde uzatan yarı otonom bir bakım asistanı olarak ele alır. Sert gövdeli robotların kablo, valf, boru ve yapısal elemanlara zarar verme ihtimaline karşı yumuşak ve şişirilebilir bir gövde seçilmiştir. Böylece robotun tank içinde uzaması, yön değiştirmesi, aydınlatma sağlaması, kamera/sensör verisi toplaması ve ileride yapay zeka destekli hasar tespitine veri üretmesi hedeflenir.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-fuel-tank-structure.png\" alt=\"Uçak yakıt tankı yapısı ve erişim mantığı\"><figcaption>Şekil 1.1. Yakıt tankı yapısı ve bakım erişim bölgeleri.</figcaption></figure></div><p>Görsel, yakıt tanklarının kanat kutusu ve merkez tank yapısı içinde nasıl konumlandığını anlatır. Ana tanklara kanat altındaki erişim panellerinden girilir; merkez tanka ise gövde içinden erişilir. Bu geometri parçalı, dar ve keskin dönüşlü olduğu için INFLOBOT'un şişirilebilir yumuşak robot olarak seçilmesi projenin temel mühendislik kararlarından biridir.</p>",
    ...
    projects: [
      ...
      },
      {
            ...
            "specs": [
                        ...
                        {
                                    "name": "Competitions & Programs",
                                    "value": "THY Design Hackathon 2023, TEKNOFEST Entrepreneurship, Take Off Istanbul"
                        },
                        {
                                    "name": "Project Team",
                                    "value": "Ahmet Soner GÜLEÇ, Özgür KURT, İltemir Taha BİNALİ, Sühan Göktuğ AYDEMİR, Bahadır SARIKARAMAN"
                        ...
                        {
                                    "name": "Problem Domain",
                                    "value": "Aircraft fuel tanks, wing inner volumes, avionics compartments, and confined MRO areas"
                        },
                        {
                                    "name": "Solution Approach",
                                    "value": "Bio-inspired inflatable soft robot with CO2 steering channels, LED illumination, and camera/sensor inspection"
                        },
                        {
                                    "name": "Subsystems",
                                    "value": "TA-8 support arm, TS-5 inspection head, oxygen support line, CO2 compressor support unit"
                        },
                        {
                                    "name": "Material & Hardware",
                                    "value": "TPE/TPU flexible body, camera/borescope, sensors, LED/OLED lighting, safe cabling, and remote-control interface"
                        },
                        {
                                    "name": "Target Outcome",
                                    "value": "A soft-robotics MRO assistant that reduces inspection time and technician risk while supporting productization"
                        }
            ],
            "overview": "<p>INFLOBOT is an AI-supported inflatable soft robot concept developed within Tulpar Tharros for aircraft fuel-tank and confined-space inspection. In line with the LIFT UP project page structure, this section presents the project through its team context, problem definition, solution approach, technical architecture, and outputs.</p><p>The project addresses aircraft fuel-tank maintenance, where technicians face narrow access panels, wing ribs, limited visibility, toxic vapor risk, fire/explosion safety concerns, oxygen deficiency, and poor ergonomics. Existing procedures require fuel drainage, power isolation, long ventilation, protective equipment, tank entry, and external safety monitoring. Source documents note that preparation and ventilation can extend from 8-12 hours to 12-24 hours depending on tank size.</p><p>INFLOBOT was framed as a semi-autonomous maintenance assistant that extends the technician's reach and vision inside these confined spaces. A compliant inflatable body was selected to reduce the contact-damage risks associated with rigid robots while enabling extension, steering, illumination, visual sensing, and future AI-supported defect detection.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-fuel-tank-structure.png\" alt=\"Aircraft fuel tank structure\"><figcaption>Figure 1.1. Fuel tank structure and maintenance access regions.</figcaption></figure></div>",
