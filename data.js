const PORTFOLIO_DATA = {
  profile: {
    ...
    about: "Eskişehir Teknik Üniversitesi Havacılık Elektrik-Elektronik Bölümü mezunuyum. Eğitimim boyunca Gaz Türbinli Motorlar, Modern Aviyonik Sistemler, Mikroişlemciler, Otomatik Uçuş Kontrol ve Navigasyon Sistemleri, Aerodinamik ile Tahribatsız Muayene Yöntemleri (NDT) gibi kritik alanlarda hem teorik hem de fakültemiz bünyesindeki SHY-145 onaylı hava aracı bakım tesislerinde pratik ve uygulamalı eğitimler aldım.\n\nÜniversite yıllarımın başından itibaren havacılık ve uzay teknolojilerine duyduğum derin merakla kendimi sürekli geliştirdim; aviyonik sistemler, uçuş kontrol yazılımları, sistem ve donanım tasarımı konularına odaklandım. Vilnius Gediminas Teknik Üniversitesi bünyesindeki staj sürecimde Airbus A320 ve Cessna 172 uçaklarının navigasyon, otopilot ve kokpit gösterge sistemlerinin bakım ve test prosedürlerinde aktif rol aldım. Havacılıkta Yapay Zeka Araştırmaları Laboratuvarı'nda ise İHA sistem tasarımı ve donanım geliştirme projeleri yürüttüm.\n\nYönetici ve üye olarak yer aldığım takımlarla birlikte TEKNOFEST, Shell Eco-marathon, Boeing 'Havacılığın Geleceği Yarışması' ve THY/Turkish Technic Design Hackathon gibi prestijli organizasyonlarda, ikincilikler ve finalistlikler dahil olmak üzere birçok önemli başarıya imza attık. Altium Designer, MATLAB/Simulink, SolidWorks, COMSOL Multiphysics ve Ansys gibi elektrik-elektronik ile mekanik analiz/tasarım programlarını yetkinlikle kullanabiliyor; aviyonik kart tasarımları, otopilot sistemleri ve 3D mekanik modellemeler gerçekleştirebiliyorum. Bu sayede, farklı mühendislik disiplinlerini bir arada yürütebilen, çok yönlü ve vizyoner bir Uçak Bakım Mühendisiyim.",
    avatar: "Foto.jpg",
    socials: {
