  ...
  en: {
    ...
    projects: [
      ...
      },
      {
            ...
            "architecture": "<h4>Fuel Tank Structure and Current Method</h4><p>Aircraft fuel tanks are located in wing boxes and center-body regions with access through panels and rib cut-outs. Current inspection procedures require fuel drainage, electrical isolation, ventilation, PPE usage, tank entry, and external safety support.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-product-modules.png\" alt=\"INFLOBOT modules\"><figcaption>INFLOBOT module logic: oxygen support, lighting, detailed inspection, mobility, and emergency support.</figcaption></figure></div><h4>Bio-inspired Soft Robot Decision</h4><p>The selected concept is a vine/inflatable soft robot inspired by sarcomere and spine-like structures. It extends through pressure, changes direction through differentiated channels, and adapts to confined aircraft structures with lower contact risk.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-soft-robot-principle.png\" alt=\"Soft robot principle\"><figcaption>Soft/vine robot extension principle.</figcaption></figure></div><h4>TA-8 and TS-5 Variants</h4><p>TA-8 focuses on lighting and oxygen support, while TS-5 focuses on confined-space visual inspection through extension arms, camera/lens systems, sensors, and directed control.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-ta8-ts5-concept.png\" alt=\"TA-8 and TS-5 concepts\"><figcaption>TA-8 and TS-5 concept variants.</figcaption></figure></div><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-co2-compressor-3d.png\" alt=\"CO2 compressor unit\"><figcaption>Team-designed CO2 compressor support unit.</figcaption></figure></div>",
            "subsystems": [
                        {
