  ...
  education: [
    {
      ...
      gpa: "3.1",
      details: "Çeşitli alanlardaki teorik derslerin yanı sıra pratik eğitimler alınmıştır:<br>• Gaz Türbinli Motorlar<br>• Modern Aviyonik Sistemler<br>• Mikroişlemciler<br>• Elektrik ve Elektronik<br>• Otomatik Uçuş Sistemleri<br>• Navigasyon Sistemleri<br>• Uçak Aerodinamiği<br>• Tahribatsız Muayene Yöntemleri (NDT)<br>• Uçak Yapıları ve Sistemleri<br>• Elektrik Makineleri<br>• Haberleşme Sistemleri Laboratuvarları<br><br>Ayrıca, fakülte bünyesindeki SHY-145 onaylı uçak bakım tesislerinde uygulamalı eğitimler aracılığıyla pratik deneyim kazanılmıştır."
    }
  ],
  experience: [
    {
