...
const UI_TRANSLATIONS = {
  tr: {
    ...
    contact_send_signal: "",
    contact_desc: "Aviyonik sistemler, gömülü donanım tasarımı, PCB geliştirme veya insansız hava aracı projeleri gibi alanlarda ortak bir çalışma yürütmek ya da teknik bir iş birliği kurmak istiyorsanız aşağıdaki kanallar üzerinden veya doğrudan mesaj aracılığıyla benimle iletişime geçebilirsiniz.",
    filter_all: "HEPSİ",
  ...
  en: {
    ...
    contact_send_signal: "",
    contact_desc: "If you would like to collaborate on projects in avionics systems, embedded hardware design, PCB development, or unmanned aerial vehicle applications, feel free to reach out through the channels below or send a direct message.",
    filter_all: "ALL",
