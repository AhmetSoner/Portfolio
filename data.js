const PORTFOLIO_DATA = {
  profile: {
    ...
    about: "Eskişehir Teknik Üniversitesi Havacılık Elektrik-Elektronik Bölümü'nden Uçak Bakım Mühendisi / Aviyonik unvanıyla mezun oldum. Mühendislik ve teknolojiye duyduğum ilgi doğrultusunda, teorik bilgiyi pratik uygulamalarla birleştiren projelerde aktif olarak görev alıyorum. Yurt dışı staj ve eğitim süreçlerimde hava araçlarının aviyonik sistem bakımı ve montaj prosedürlerinin yanı sıra mekanik tasarım, PCB donanım tasarımı ve simülasyon/analiz çalışmaları üzerine odaklandım.\n\nKurucu ortağı olduğum Tulpar Tharros bünyesinde yapay zeka destekli havacılık muayene robotu projeleri geliştirirken; alternatif enerjili araçlar üreten Hidroana ekibinde ise elektrik-elektronik alt sistem tasarımı, entegrasyonu ve güç elektroniği konularında aktif roller üstlenerek TEKNOFEST ve Shell Eco-marathon gibi ulusal/uluslararası organizasyonlarda dereceler elde ettim.\n\nAyrıca kurucusu olduğum Havacılıkta Yapay Zeka Araştırmaları Topluluğu çatısı altında; otonom sistemler, uçuş kontrol yazılımları ve yapay zeka entegrasyonuna odaklanan TUSAŞ LIFT-UP, TÜBİTAK 2209-A ve 2209-B projelerini başarıyla yönettim. Edindiğim bu teorik altyapı, saha deneyimi ve disiplinler arası mühendislik yetkinlikleriyle; havacılık ve uzay teknolojilerinde yenilikçi ve yüksek katma değerli çözümler üretme hedefiyle geleceğe yürüyen kararlı bir Uçak Bakım Mühendisiyim.",
    avatar: "Foto.jpg",
    socials: {
