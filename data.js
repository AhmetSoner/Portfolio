const PORTFOLIO_DATA = {
  profile: {
    ...
    about: "Eskişehir Teknik Üniversitesi Havacılık Elektrik-Elektronik Bölümü'nden Uçak Bakım Mühendisi / Aviyonik unvanıyla mezun oldum. Eğitimim süresince Gaz Türbinli Motorlar, Modern Aviyonik Sistemler, Mikroişlemciler, Otomatik Uçuş Kontrol ve Seyrüsefer Sistemleri, Uçak Aerodinamiği ile Tahribatsız Muayene Yöntemleri (NDT) gibi kritik alanlarda teorik derslerin yanı sıra üniversitemiz bünyesindeki SHY-145 onaylı uçak bakım tesislerinde uygulamalı eğitimler alarak pratik deneyim kazandım.\n\nMühendislik ve teknolojiye duyduğum ilgi doğrultusunda, teorik bilgiyi pratik uygulamalarla birleştiren projelerde aktif olarak görev alıyorum. Vilnius Gediminas Teknik Üniversitesi bünyesindeki staj sürecimde; Cessna 310, Cessna 152 ve Airbus A320 gibi uçaklar üzerinde aviyonik sistemlerin söküm, montaj, bakım ve test prosedürlerini uyguladım. Ardından uygulamalı eğitimimi EASA Part-145 sertifikalı Kyviškės Havaalanı'nda sürdürerek uçuşa elverişli Cessna 172S ve Piper PA-34 uçakları üzerinde EASA Part-66 lisanslı uzmanlar denetiminde çalıştım. Sonrasında ise insansız hava araçlarının mekanik tasarımı (SolidWorks/XFLR5), baskı devre kartı tasarımı (Altium Designer ile ESC kartı), PSpice ve MATLAB/Simulink ile devre simülasyonları ve COMSOL Multiphysics ile termal analizler yürüttüm.\n\nKurucu ortağı olduğum Tulpar Tharros topluluğu ile geliştirdiğimiz yapay zeka destekli havacılık MRO robotu INFLOBOT projesiyle TEKNOFEST Girişimcilik Yarışması'nda 'En İyi Girişim' ödülüne layık görüldük ve THY Design Hackathon'da finalist olduk. Hidroana proje takımında DORLION ve MIDAS hidrojenli araçlarının elektrik-elektronik sistemlerini, sistem mühendisliği yaklaşımıyla geliştirdim ve TEKNOFEST Verimlilik Yarışması'nda ikincilik ile 'Elektronik Sistemler Özel Jüri Ödülü' kazandık. Ayrıca EESTEC bünyesinde aktif görev alarak uluslararası alanda mühendislik organizasyonları yönettim. Altium Designer, MATLAB, SolidWorks, COMSOL ve PSpice gibi araçları yetkinlikle kullanan, çok yönlü ve vizyoner bir Uçak Bakım Mühendisiyim.",
    avatar: "Foto.jpg",
    socials: {
  ...
  experience: [
    ...
    },
    {
      ...
      details: "Sürdürülebilir hidrojen yakıtlı DORLION ve MIDAS araçlarının elektrik-elektronik alt sistem entegrasyonu, teknik gereksinim analizi ve görev tanımlarının oluşturulması. Altium Designer ile PCB tasarımı, şematik çizimler, güç ve sinyal devre simülasyonları. TEKNOFEST Verimlilik Yarışması'nda Türkiye İkinciliği ve Elektronik Sistemler Özel Jüri Ödülü."
    },
    {
