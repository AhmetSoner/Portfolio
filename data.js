    ...
    projects: [
      ...
      },
      {
          ...
          "specs": [
                    {
                              "name": "Project / Target",
                              "value": "Isolation Monitoring Device (IMD)"
                    },
                    {
                              "name": "Rated Voltage",
                              "value": "48 V DC nominal input (up to 100 V DC max)"
                    },
                    {
                              "name": "Measurement Method",
                              "value": "Switched Resistor Network (Electric Bridge Switch)"
                    },
                    {
                              "name": "Galvanic Isolation",
                              "value": "AMC1311 isolated amplifier & opto-couplers, > 1.5 kV isolation"
                    },
                    {
                              "name": "Safety Standards",
                              "value": "Designed in compliance with TS EN 61557-8 and TEKNOFEST EC regulations"
                    },
                    {
                              "name": "Design & Verification",
                              "value": "Altium Designer PCB design, LTspice simulations, hardware prototype testing"
                    }
          ],
          "overview": "<p>This page describes the design, operating principles, simulation, and software architecture of the Isolation Monitoring Device developed for alternative energy vehicles. The study focuses on measuring the leakage resistance between the high voltage bus (48 V DC) and the vehicle chassis in compliance with international safety standards.</p><h4>4.1. Operating Principles of Switched Resistor Network</h4><p>The device uses a switched resistor network (electric bridge) to measure leakage resistance. By switching reference resistors connected to the positive and negative poles of the battery to the chassis sequentially, voltage drops across these resistors are measured. Using these voltage values, the insulation resistance of both poles to the chassis is calculated mathematically.</p><div class='hud-table-wrap'><table class='hud-benchmark-table'><thead><tr><th>Parameter</th><th>Value</th></tr></thead><tbody><tr><td>Nominal Bus Voltage</td><td>48 V DC</td></tr><tr><td>Maximum Bus Voltage</td><td>100 V DC</td></tr><tr><td>Reference Resistors</td><td>100 kΩ (0.1% tolerance)</td></tr><tr><td>Switching Elements</td><td>Opto-isolated Solid State Relays</td></tr><tr><td>Sampling Period</td><td>500 ms per cycle</td></tr></tbody></table></div>",
          "architecture": "<p>The hardware architecture consists of high-voltage divider networks, solid-state switches, difference amplifiers, and isolation barriers. The design isolates high-voltage lines from the low-voltage microcontroller unit (MCU) using galvanic isolation techniques.</p><h4>4.2. Signal Conditioning and Isolation Barrier</h4><p>The voltage drops measured across the switched resistors are conditioned using the AD8216 difference amplifier. The AD8216 is a high-bandwidth difference amplifier with a wide common-mode voltage range, making it ideal for high-voltage environments. The conditioned analog signal is then transmitted to the low-voltage side using the AMC1311 isolated amplifier. The AMC1311 provides galvanic isolation up to 1.5 kV, protecting the low-voltage microcontroller from voltage spikes.</p><div class='project-figure-grid inline-figure-flow'><figure class='project-figure-card'><img src='imd/Resim30.png' alt='Isolation Monitoring Circuit Schematic'><figcaption>Figure 1. Isolation Monitoring Circuit Schematic.</figcaption></figure></div>",
          "subsystems": [
                    {
                              "title": "Switched Resistor Network",
                              "desc": "A network of high-precision resistors and solid-state switches used to establish temporary reference bridges to the chassis."
                    },
                    {
                              "title": "AD8216 Difference Amplifier",
                              "desc": "High common-mode voltage difference amplifier used to measure voltage drops across reference resistors."
                    },
                    {
                              "title": "AMC1311 Isolated Transmitter",
                              "desc": "Galvanic isolation barrier providing high-voltage isolation and transmitting analog signals to the low-voltage MCU."
                    },
                    {
                              "title": "Opto-Isolator and Relay Drive",
                              "desc": "Control circuits that drive solid-state switches while maintaining complete isolation between MCU control lines and the high-voltage stage."
                    }
          ],
          "analysis": "<p>Simulation and testing verified that the symmetric and asymmetric leakages could be detected within a ±5% tolerance range. The response time of the system in detecting critical leakage levels is less than 1.5 seconds, which meets both TEKNOFEST EC and international safety norms.</p>",
          "achievements": "The isolation monitoring device was successfully prototyped and integrated into the Hidroana vehicle. It passed all technical inspections of the TEKNOFEST Efficiency Challenge and Shell Eco-marathon competitions, confirming the safety of the vehicle's high-voltage electrical subsystem."
      },
      {
          "id": "project-3",
          ...
          "specs": [
                    {
                              "name": "Project / Version",
                              "value": "Three-Phase BLDC Motor Driver Board - Vol.2 (Stack Design)"
                    },
                    {
                              "name": "Power / Current",
                              "value": "2.0 kW / 48 V / 42 A nominal operation"
                    },
                    {
                              "name": "Driver Architecture",
                              "value": "Modular stack: Power board, Control board, Regulator board"
                    },
                    {
                              "name": "Switching / Driver",
                              "value": "IRF1404 MOSFETs, IRS21867S high/low-side drivers"
                    },
                    {
                              "name": "PCB Layout",
                              "value": "4-layer power board, 2-layer control and regulator boards"
                    },
                    {
                              "name": "Verification & Tests",
                              "value": "Altium Designer PCB, PSpice circuit simulations, thermal imaging, dyno load tests"
                    }
          ],
          "overview": "<p>This page describes the second-generation (Vol.2) BLDC motor driver board, which features a modular three-board stack architecture. This stack design separates the high-power switching stage from the low-power microcontroller and regulator sections, significantly reducing electromagnetic interference (EMI) and improving thermal distribution.</p><h4>4.1. Stack Board Architecture</h4><p>The Vol.2 driver is split into three separate boards: the Power Board, the Control Board, and the Regulator Board. Connection between these boards is established via high-density headers, allowing a compact stack layout while maintaining physical and electrical isolation between power and signal stages.</p><div class='hud-table-wrap'><table class='hud-benchmark-table'><thead><tr><th>Board Name</th><th>Layer Count</th><th>Key Components</th></tr></thead><tbody><tr><td>Power Board</td><td>4 Layers</td><td>IRF1404 MOSFETs, IRS21867S drivers, DC-link caps</td></tr><tr><td>Control Board</td><td>2 Layers</td><td>STM32F446RET6 MCU, Hall sensor interfaces, debug headers</td></tr><tr><td>Regulator Board</td><td>2 Layers</td><td>TL783, LM2596, isolated DC/DC converters</td></tr></tbody></table></div>",
          "architecture": "<p>The power board features a 4-layer design with heavy copper (2 oz) to handle up to 42 A continuous current. Traces for the gate drive signals were routing with matched lengths to minimize switching skew between parallel MOSFETs.</p><h4>4.2. PCB Design and Noise Mitigation</h4><p>By routing the gate drive signals on the inner layers of the 4-layer power board, shielded by ground planes, switching noise was drastically reduced compared to the Vol.1 design. The bypass capacitors were placed directly beneath the driver ICs to minimize parasitic loop inductance.</p><div class='project-figure-grid inline-figure-flow'><figure class='project-figure-card'><img src='vol2/Resim31.png' alt='Vol.2 Stack Board 3D Model'><figcaption>Figure 1. Vol.2 Stack Board 3D Model.</figcaption></figure></div>",
          "subsystems": [],
          "analysis": "<p>Under dyno load tests at 48 V and 42 A, the modular stack driver operated stably with an average efficiency of 92%. Thermal camera measurements showed that the peak temperature on the power board did not exceed 65°C under continuous load, confirming the effectiveness of the copper pours and the stack thermal design.</p>",
          "achievements": "The Vol.2 BLDC motor driver was successfully deployed in the Hidroana vehicle. It ran flawlessly during all practice runs and competitive stages, providing stable motor speed control and improved energy efficiency."
      },
      {
          "id": "project-4",
          ...
          "specs": [
                    {
                              "name": "Project / Scope",
                              "value": "Deep Learning Based Bird Detection System - TÜBİTAK 2209-A"
                    },
                    {
                              "name": "AI Model",
                              "value": "YOLOv8n (Ultralytics), optimized for edge computing"
                    },
                    {
                              "name": "Dataset Pipeline",
                              "value": "Roboflow labeling, augmentation (exposure, noise, crop), 5000+ images"
                    },
                    {
                              "name": "Detection Metrics",
                              "value": "Precision: 89.2%, Recall: 86.5%, mAP50: 88.4%"
                    },
                    {
                              "name": "Hardware Target",
                              "value": "NVIDIA Jetson / Raspberry Pi 4 edge deployment"
                    },
                    {
                              "name": "Warning Logic",
                              "value": "Runway sector grid mapping, automatic sound warning output"
                    }
          ],
          "overview": "<p>This page describes the design, training pipeline, and software integration of the Bird Strike Prevention System. The system processes video streams in real-time to detect, track, and classify birds in the runway zone, triggering automated alarm systems to deter birds before aircraft arrival.</p><h4>4.1. YOLOv8 Object Detection Pipeline</h4><p>The core detection engine is based on YOLOv8n (nano), selected for its high inference speed on edge computing hardware. The model was trained on a custom annotated dataset containing various bird species in different flight postures and lighting conditions.</p><div class='hud-table-wrap'><table class='hud-benchmark-table'><thead><tr><th>Metric</th><th>Target Value</th><th>Achieved Value</th></tr></thead><tbody><tr><td>Precision</td><td>> 85%</td><td>89.2%</td></tr><tr><td>Recall</td><td>> 80%</td><td>86.5%</td></tr><tr><td>mAP50</td><td>> 80%</td><td>88.4%</td></tr><tr><td>Inference Latency</td><td>< 30 ms</td><td>24.5 ms (Jetson Orin Nano)</td></tr></tbody></table></div>",
          "architecture": "<p>The software pipeline consists of video decoding, frame resizing, tensor preparation, model inference, post-processing (NMS), tracking (ByteTrack), and early warning zone collision checks.</p><h4>4.2. Dataset Augmentation and Annotation</h4><p>Using Roboflow, the dataset was augmented with random crops, exposure adjustments, and gaussian noise to make the model robust against diverse weather conditions (fog, rain, direct sun). An annotated database of over 5000 images was used for training.</p><div class='project-figure-grid inline-figure-flow'><figure class='project-figure-card'><img src='bird/photo-08.jpg' alt='Detection System in Action'><figcaption>Figure 1. Detection System in Action.</figcaption></figure></div>",
          "subsystems": [
                    {
                              "title": "Data Acquisition & Prioritization",
                              "desc": "Camera stream decoding and frame queue management with priority sorting based on runway sector activity."
                    },
                    {
                              "title": "Roboflow Annotation Pipeline",
                              "desc": "Cloud-based annotation, review, and data augmentation pipeline yielding optimized training sets."
                    },
                    {
                              "title": "YOLOv8n Inference Model",
                              "desc": "The core convolutional network trained on birds, exported to TensorRT for fast edge inference."
                    },
                    {
                              "title": "Alert & Integration Logic",
                              "desc": "Zone-based alert generation system that calculates distance to runway and triggers acoustic/visual deterrents."
                    }
          ],
          "analysis": "<p>Test runs showed that the YOLOv8n model could reliably detect small birds up to 80 meters and larger birds up to 150 meters. The ByteTrack integration successfully maintained tracking IDs through occlusions behind airport structures, reducing false alarms by 94%.</p>",
          "achievements": "Supported under the TÜBİTAK 2209-A program, this project was presented at national aviation congresses. The developed model serves as an active research base for smart airport infrastructure within HAYA."
      },
      {
          "id": "project-5",
