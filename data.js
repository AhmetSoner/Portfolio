  ...
  tr: {
    ...
    projects: [
      ...
      },
      {
            ...
            "image": "inflobot-figures/inflobot-pneui-cover.png",
            "detailImage": "inflobot-figures/inflobot-pneui-cover.png",
            "teamIds": [
                        "team-tulpar-tharros"
            ],
            "tags": [
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
            ...
            "overview": "<p>INFLOBOT is an AI-supported inflatable soft robot concept developed within Tulpar Tharros for aircraft fuel-tank and confined-space inspection. In line with the LIFT UP project page structure, this section presents the project through team context, industry problem, solution approach, technical architecture, and outputs.</p><p>The problem domain covers aircraft fuel tanks, wing inner volumes, avionics compartments, and confined MRO areas that are not ergonomically suitable for technicians. Existing procedures require fuel drainage, power isolation, long ventilation, protective equipment, tank entry, and external safety monitoring. Source documents note that preparation and ventilation can extend from 8-12 hours to 12-24 hours depending on tank size.</p><p>The solution approach is a bio-inspired inflatable soft robot. INFLOBOT is designed to steer through CO2 pressure channels, carry LED illumination, support camera/sensor inspection, and provide data for future AI-supported defect detection. The defined subsystems include the TA-8 support arm, TS-5 inspection head, oxygen support line, and CO2 compressor support unit. Material and hardware decisions include a TPE/TPU flexible body, camera/borescope, sensors, LED/OLED lighting, safe cabling, and remote-control logic.</p><div class=\"project-figure-grid inline-figure-flow\"><figure class=\"project-figure-card\"><img src=\"inflobot-figures/inflobot-fuel-tank-structure.png\" alt=\"Aircraft fuel tank structure\"><figcaption>Figure 1.1. Fuel tank structure and maintenance access regions.</figcaption></figure></div>",
